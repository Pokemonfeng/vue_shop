<template>
  <div>
    ...
    <el-dialog
      title="分配角色"
      :visible.sync="setRoleDialogVosonle"
      width="50%"
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="setRoleDialogVosonle = false">取 消</el-button>
...
export default {
  data() {
    ...
    var checkMobile = (rule, value, cd) => {
      const regMobile = /^(0|86|17951)?(13[0-9]|15[0123456789]|17[678]|[0-9]|14[57])[0-9]{8}$/
  ...
  methods: {
    ...
    async setRole(userInfo) {
      ...
      this.setRoleDialogVosonle = true
    },
    async saveRoleInfo() {
      ...
      this.getUserList()
      this.setRoleDialogVosonle = false
    },
    setRoleDialogClosed() {
      this.selectedRoleId = ''
      this.userInfo = {}
